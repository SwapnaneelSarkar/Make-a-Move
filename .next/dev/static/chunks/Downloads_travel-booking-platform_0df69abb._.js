...
function WalletBalanceWidget() {
    ...
    const balance = currentUser?.walletBalance || 2543000;
    ...
    const getMinutesAgo = ()=>{
        const diff = Math.floor((new Date().getTime() - lastUpdated.getTime()) / 1000 / 60);
...
_s(WalletBalanceWidget, "S+goigvOHJpGP9SFIWsn4eE3BHQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$booking$2d$platform$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"]
    ];
});
...
//# sourceMappingURL=Downloads_travel-booking-platform_0df69abb._.js.map