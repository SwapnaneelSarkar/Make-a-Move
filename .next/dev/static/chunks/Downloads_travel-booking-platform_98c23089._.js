    ...
    const handleNextStage = async ()=>{
        ...
        if (currentStage === "Listing") {
            ...
            if (paymentData.walletUsage) {
                const { hasSufficientBalance, getWalletBalance } = await __turbopack_context__.A("[project]/Downloads/travel-booking-platform/lib/wallet-utils.ts [app-client] (ecmascript, async loader)");
                const walletBalance = getWalletBalance();
                if (!hasSufficientBalance(totalAmount1)) {
            ...
            if (nextStage === "Booking Confirmed") {
                ...
                try {
                    ...
                    if (paymentData.walletUsage && selectedFlight) {
                        const { createTransaction } = await __turbopack_context__.A("[project]/Downloads/travel-booking-platform/lib/wallet-utils.ts [app-client] (ecmascript, async loader)");
...
//# sourceMappingURL=Downloads_travel-booking-platform_98c23089._.js.map